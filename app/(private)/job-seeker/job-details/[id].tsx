...
const JobDetailsScreen = () => {
  ...
  const [appliying, setApplying] = React.useState(false);
  ...
  const onApply = async () => {
    try {
      ...
      Toast.show({
        ...
        text2: "You have successfully applied for the job.",
      });
        ...
        <FlexBox flex={1} padding={20} gap={20} backgroundColor={"white"}>
          ...
          <FlexBox gap={7}>
            ...
            <CustomText
              fontColor="#5d5c5c"
              value={
                dayjs(jobData?.last_date_to_apply).format("MMMM D, YYYY") ||
                "N/A"
              }
            />
          </FlexBox>
          ...
          <FlexBox gap={7}>
            ...
            <CustomText
              fontColor="#5d5c5c"
              value={jobData?.small_description!}
            />
          </FlexBox>
          ...
          <FlexBox gap={7}>
            ...
            <CustomText
              fontColor="#5d5c5c"
              value={jobData?.full_description!}
            />
          </FlexBox>

          <FlexBox>
            <CustomButton onPress={onApply} disabled={appliying}>
              Apply
            </CustomButton>
